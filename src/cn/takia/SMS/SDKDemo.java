...
public class SDKDemo {
    ...
    public static void sendCodeWithTel(String code,String tel) {
        // 用户账号
        String userid = "E1047M";
        ...
        // 单条发送
        singleSend(smsSendConn, userid,code,tel);
     ...
     *            用户账号
     */
    public static void singleSend(SmsSendConn smsSendConn, String userid,String code,String tel) {
        try {
            // 参数类
